  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="nav-menu">
        ...
        <Link to="/classes" className={`nav-item ${location.pathname === '/classes' ? 'active' : ''}`}>
          📚 クラス一覧
        </Link>
        <Link to="/consults" className={`nav-item ${location.pathname === '/consults' ? 'active' : ''}`}>
          💬 相談リクエスト
        </Link>
      ...
      <div className="app-container">
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/consults" element={<ConsultRequestPage />} />
